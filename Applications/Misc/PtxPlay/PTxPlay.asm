...
DONE0	LD B,A
	...
	LD C,A
	LD A,R
	ADD C	; Terrible RNG algo
DONE1	CP B	; Rand < Maxfile?
	JR C,DONE2
	SUB B
	JR DONE1
DONE2	LD L,A	; Get the file
	CALL LOOKUP
	SLA C
	SLA C
	SLA C
...
; Search for a PT2 or PT3 file
; l = PT? number to stop at
;
; Returns last index in h
LOOKUP
	PUSH HL
	LD C,#1A
	LD DE,#0080
